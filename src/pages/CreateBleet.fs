...
let mainElem (state: State) (dispatch: Msg -> unit) =
    ...
    Html.div [ prop.id "CreateBleetModal"
               prop.onClick (fun event -> dispatch (OutsideModalClickClose event.target?id))
               prop.classes classes
               prop.children [ Html.div [ prop.classes [ tw.border
                                                         tw.``border-blue-500``
                                                         tw.``shadow-lg``
                                                         tw.``bg-white``
                                                         tw.``md:max-w-md``
                                                         ...
                                                         tw.flex
                                                         tw.``flex-col`` ]
                                          prop.children [ Html.button [ prop.classes [ tw.flex
                                                                                       tw.``flex-row`` ]
                                                          ...
                                                          Html.div [ prop.classes [ tw.flex
                                                                                    tw.``flex-row``
                                                                                    tw.``mt-4`` ]
                                                                     prop.children [ Html.img [ prop.classes [ tw.flex
                                                                                                               tw.``flex-grow-0``
                                                                                                               tw.``mr-2``
                                                                                                               tw.``h-8``
                                                                                                               tw.``w-8``
                                                                                     ...
                                                                                     Html.div [ prop.classes [ tw.flex
                                                                                                               tw.``flex-grow-1``
                                                                                                               tw.``flex-col`` ]
                                                                                                prop.children [ Html.textarea [ prop.id
                                                                                                                                    "create-bleet-text"
                                                                                                                                prop.classes [ tw.``resize-none``
                                                                                                                                               tw.``outline-none`` ]
                                                                                                                                prop.rows
                                                                                                                                    3
                                                                                                                                prop.value
                                                                                                                ...
                                                                                                                Html.div [ prop.classes [ tw.flex
                                                                                                                                          tw.``flex-row-reverse`` ]
                                                                                                                           prop.children [ Html.button [ prop.id
                                                                                                                                                             "create-bleet-button"
                                                                                                                                                         prop.classes [ tw.``bg-green-500``
                                                                                                                                                                        tw.``text-white``
                                                                                                                                                                        tw.``rounded-md``
                                                                                                                                                                        tw.``px-8``
                                                                                                                                                                        tw.``py-2``
...
let render (state: State) (dispatch: Msg -> unit) =
    Html.div [ prop.classes [ tw.``ml-3`` ]
               prop.children [ (mainElem state dispatch) ] ]
